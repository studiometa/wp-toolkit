...
class TransientCleanerTest extends WP_UnitTestCase
{
    ...
    public function test_merge_stored_transients_option_values()
    {
        ...
        $test_merge_values = $this->transient_cleaner->merge_stored_transients_option_values(
            array( 'foo' ),
            array( 'foo_old' )
        );
        $test_merge_values_already_exists = $this->transient_cleaner->merge_stored_transients_option_values(
            array( 'foo' ),
            array( 'foo_old', 'foo' )
        );
